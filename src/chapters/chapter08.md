...
本章は、[AI活用の標準業務フロー（1枚）](../../docs/introduction/02-standard-workflow/index.md) の全体を、具体的な業務場面へ展開します。特に次の工程を横断します。
...
- 前章: [第7章：批判的思考とメディアリテラシー](../../docs/chapters/chapter07/index.md)
- 次章: [第9章：AIリスク管理と倫理的配慮](../../docs/chapters/chapter09/index.md)
