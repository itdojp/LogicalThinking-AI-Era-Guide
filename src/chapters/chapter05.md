...
- **[context pack](../../docs/appendices/appendix-c/index.md#term-context-pack)**: AIに渡す資料、渡さない資料、用語、前提、除外情報、情報分類をまとめた入力パッケージ。
...
[CRISP-P](../../docs/appendices/appendix-c/index.md#term-crisp-p)は、指示を構造化するための便利な型です。ただし、これだけで業務上の安全性や採否判断が保証されるわけではありません。本章では、CRISP-Pを task brief、context pack、output schema、acceptance criteria の一部として使います。
...
AIに大量の情報を渡しても、必要な前提と不要な情報が混ざると出力は不安定になります。[context pack](../../docs/appendices/appendix-c/index.md#term-context-pack)では、使う情報、使わない情報、優先順位を整理します。
