...
第6章で扱う CARE+評価も、この章の延長にあります。正確性だけでなく、読み手への適合、意思決定点との関連、根拠、リスク、承認条件を合わせて確認します。
...
次のテンプレートは、第1章で作る最小成果物です。第5章以降で、より詳細な task brief、output schema、evaluation rubric へ発展させます。
