...
- **[CARE+](../../docs/appendices/appendix-c/index.md#term-care-plus)評価シート**: [CARE](../../docs/appendices/appendix-c/index.md#term-care)に、Evidence（根拠）、Risk（リスク）、Approval（承認条件）を加え、AI出力の採否を判断するシート。
...
[CARE](../../docs/appendices/appendix-c/index.md#term-care)は、AI出力を評価するときの本書独自の基本観点です。
...
本書では、実務利用の評価として、CAREに次の3観点を加えた[CARE+](../../docs/appendices/appendix-c/index.md#term-care-plus)を使います。
