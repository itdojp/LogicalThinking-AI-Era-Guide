...
- **negotiation option / [BATNA](../../docs/appendices/appendix-c/index.md#term-batna) map**: 選択肢、代替案、譲歩可能範囲、非交渉条件、合意しない場合の対応を整理する地図。
...
negotiation option / BATNA map は、合意に向けた選択肢と、合意しない場合の対応を整理する地図です。[BATNA](../../docs/appendices/appendix-c/index.md#term-batna)はBest Alternative to a Negotiated Agreementの略で、「合意できなかった場合の最善の代替案」として扱います。相手を脅す材料ではなく、自社の判断基準として使います。
