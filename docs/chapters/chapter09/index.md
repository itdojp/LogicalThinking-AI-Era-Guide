...
> **重要**: 本章で紹介する情報分類やセキュリティ対策の例は、あくまで一般的な考え方のサンプルです。実際の業務で外部AIサービスや社内AIを利用する際は、必ず自社の情報セキュリティポリシーやAI利用ルール、関連する法規制に従ってください。特に、本番データや顧客情報などの機密情報を外部サービスに入力することは避けるか、組織として明示的に許可された範囲に限定する必要があります。
