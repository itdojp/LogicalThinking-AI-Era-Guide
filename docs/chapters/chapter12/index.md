...
- **4. 出力仕様**: agenda、minutes、decision log、action tracker、dissent register の形式を定義する。
...
本章では、会議を「時間枠」ではなく「意思決定と合意形成の成果物」として扱います。agenda、minutes、decision log、dissent register、follow-up tracker を一体で設計します。
...
意思決定点:
今回決めないこと:
期待する成果物: 議事録 / decision log / action tracker / 合意条件 / 次回論点
参加者:
必須参加者と理由:
任意参加者と理由:
承認者 / 決裁者:
...
| 50-60分 | 決定と次アクション | 実行条件を確定する | 担当・期限・承認者が明確 | action tracker | 決裁者 / 担当者 | decision log |
```
...
| 現場責任者 | 実行責任者 | 現場負荷、品質、期限 | 実行可否に影響 | 工数見積 | 実行条件 | action tracker更新 |
...
| --- | --- | --- | --- | --- | --- |
| 10:15 | 現場負荷が増える可能性 | 懸念 | 現場責任者の経験 | 工数見積 | action trackerへ |
...
- 会議メモから minutes、decision log、action tracker のドラフトを作る。
...
担当と期限だけでは、完了したか判断できません。成果物、完了条件、承認者を action tracker に入れます。
...
- 前章: [第11章：説得力のあるプレゼンテーション](../chapter11/)
- 次章: [第13章：論理的な交渉・説得術](../chapter13/)
