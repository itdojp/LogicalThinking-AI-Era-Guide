...
- **[CARE+](../../appendices/appendix-c/#term-care-plus)評価シート**: [CARE](../../appendices/appendix-c/#term-care)に、Evidence（根拠）、Risk（リスク）、Approval（承認条件）を加え、AI出力の採否を判断するシート。
...
[CARE](../../appendices/appendix-c/#term-care)は、AI出力を評価するときの本書独自の基本観点です。
...
本書では、実務利用の評価として、CAREに次の3観点を加えた[CARE+](../../appendices/appendix-c/#term-care-plus)を使います。
...
- 前章: [第5章：AIへの指示（プロンプト）設計](../chapter05/)
- 次章: [第7章：批判的思考とメディアリテラシー](../chapter07/)
