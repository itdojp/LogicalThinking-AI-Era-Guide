...
【反例候補】変更禁止時間帯なら、テストと承認があっても開始できない。
```

反例候補が見つかった場合は、主張を直ちに全否定するのではなく、適用範囲や不足条件を見直します。この例では、「変更禁止時間帯ではない」を前提へ追加すべきだと分かります。
...
- 前章: [第1章：なぜ今、論理的思考が必要なのか](../chapter01/)
- 次章: [第3章：情報の整理と分析](../chapter03/)
