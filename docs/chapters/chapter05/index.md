...
3. 影響度と緊急度の評価
4. 解決策の優先順位
【制約】MECE（Mutually Exclusive, Collectively Exhaustive：モレなくダブりなく）原則に従い、客観的データに基づく
...
この章ではAIに効果的な指示を出す方法を学びました。

次の第6章では、AIから得られた出力を適切に評価し、改善していく方法を学びます。AIとの協働において、出力の品質を見極め、より良い結果を得るための技術を身につけましょう。
