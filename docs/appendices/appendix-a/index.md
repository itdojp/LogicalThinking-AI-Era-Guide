...
| Relevance / 関連性 | 意思決定点に直接答えているか | OK / NG / 要確認 | output schema を修正する |
| Effectiveness / 効果性 | 次アクション、承認、再利用につながるか | OK / NG / 要確認 | governance checklist を追加する |
| Evidence / 根拠 | 主張と根拠が追跡できるか | OK / NG / 要確認 | evidence matrix を作る |
| Risk / リスク | 法務、セキュリティ、誤情報、過剰断定を扱ったか | OK / NG / 要確認 | risk register へ残す |
| Approval / 承認 | 誰が最終判断するか明確か | OK / NG / 要確認 | approval log を作る |
