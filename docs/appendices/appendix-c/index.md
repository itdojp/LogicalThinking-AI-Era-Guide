...
**定義**: AI出力を評価するための本書の観点で、内容の正確さ、適合性、リスク、説明可能性を確認する枠組みです。組織固有の評価項目を追加して使います。

**使いどころ**: 出力の文章品質だけでなく、目的への適合、根拠、リスク、承認可能性をレビューします。CAREを満たすことは、事実性や効果を自動的に保証することではありません。
